...
.simple-asset-editor-modal {
  max-width: 660px;
  display: flex;
  flex-direction: column;
  overflow: hidden;
}
.simple-asset-editor-modal .modal-body { min-height: 0; overflow-y: auto; }
...
.modal--wizard .modal-footer { flex: 0 0 auto; position: static; }
.wizard-body { display: grid; grid-template-columns: 190px minmax(0, 1fr); min-height: 390px; flex: 1 1 auto; overflow: hidden; }
.wizard-steps { display: flex; flex-direction: column; gap: 4px; padding: 18px 10px; border-right: 1px solid var(--border); background: var(--bg-subtle); overflow-y: auto; }
...
.wizard-pane { padding: 22px 26px 26px; display: flex; flex-direction: column; gap: 14px; min-height: 0; overflow-y: auto; }
...
.wizard-divider { display: flex; align-items: center; gap: 10px; color: var(--text-tertiary); font: 600 9.5px var(--font-mono); letter-spacing: .1em; text-transform: uppercase; margin-top: 2px; }
.wizard-divider::before,
.wizard-divider::after { content: ''; height: 1px; background: var(--border); flex: 1; }
