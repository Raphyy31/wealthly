      ...
      <div className="bento-grid">
        ...
        <div className="bento-tile tile-net">
          ...
          <svg className="tile-spark" viewBox="0 0 200 50" preserveAspectRatio="none">
            ...
            <path d="M0,38 C20,34 35,28 55,30 C75,32 90,22 115,20 C140,18 155,14 175,10 C190,8 200,6 200,6"
                  fill="none" stroke="#7E92FF" strokeWidth="2" strokeLinecap="round"/>
        ...
        <div className="bento-tile tile-family">
          ...
          <div className="tile-family-stack">
            {['MR', 'CR', 'EM', 'PM'].map((n, i) => (
              <div key={i} className="tile-avatar" style={{ background: ['#7E92FF','#4FB57A','#E0975A','#A6B4FF'][i] }}>
                {n}
              </div>
            ))}
          </div>
        ...
        <div className="bento-tile tile-fiscal">
          ...
          <div className="tile-fiscal-rows">
            <div className="tile-fiscal-row">
              ...
              <span className="tile-fiscal-bar"><span style={{width:'42%', background:'#7E92FF'}}/></span>
            </div>
            <div className="tile-fiscal-row">
          ...
          <div className="tile-security-content">
            <svg className="tile-shield" viewBox="0 0 32 32" fill="none">
              <path d="M16 3 L28 7 V16 C28 23 22 28 16 30 C10 28 4 23 4 16 V7 Z"
                    fill="none" stroke="#7E92FF" strokeWidth="1.4"/>
              <path d="M11 16 L14.5 19.5 L22 12" fill="none" stroke="#7E92FF" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <div>
