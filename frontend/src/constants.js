...
export const DEFAULT_CATEGORIES = [
  ...
  { id: 'household_cleaning', name: 'Produits ménagers',       color: '#c26b3e', type: 'expense', icon: '🧴', kind: 'needs', parent: 'housing' },
  { id: 'household_laundry',  name: 'Pressing & blanchisserie',color: '#b56043', type: 'expense', icon: '👔', kind: 'needs', parent: 'housing' },
  { id: 'household_help',     name: 'Aide à domicile',         color: '#a85548', type: 'expense', icon: '🤲', kind: 'needs', parent: 'housing' },
  ...
  { id: 'insurance_loan',  name: 'Assurance de prêt',   color: '#a03a12', type: 'expense', icon: '📋', kind: 'needs', parent: 'insurance' },
  ...
  { id: 'sport',     name: 'Sport & Fitness',    color: '#8838cc', type: 'expense', icon: '🏋️', kind: 'wants', parent: 'subscriptions' },
  ...
  { id: 'household', name: 'Ménage',             color: '#78716c', type: 'expense', icon: '🧹', kind: 'needs', parent: 'housing' },
