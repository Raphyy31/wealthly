...
export const DEFAULT_CATEGORIES = [
  ...
  { id: 'sport', name: 'Sport & Fitness', color: '#f97316', type: 'expense', icon: '💪', kind: 'wants' },
  { id: 'streaming', name: 'Streaming & Médias', color: '#a855f7', type: 'expense', icon: '🎬', kind: 'wants' },
  { id: 'childcare', name: 'Garde & Crèche', color: '#f59e0b', type: 'expense', icon: '🧸', kind: 'needs' },
  { id: 'pharmacy', name: 'Pharmacie', color: '#ef4444', type: 'expense', icon: '💊', kind: 'needs' },
