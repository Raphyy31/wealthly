...
DEFAULT_CATEGORIES = [
    ...
    {"slug": "mortgage_interest", "name": "Crédit immobilier", "color": "#4845d4", "type": "expense", "icon": "🏠", "kind": "needs", "parent_slug": "loans"},
    {"slug": "loan_auto", "name": "Crédit auto", "color": "#4338ca", "type": "expense", "icon": "🚗", "kind": "needs", "parent_slug": "loans"},
    {"slug": "loan_student", "name": "Crédit étudiant", "color": "#3e31be", "type": "expense", "icon": "🎓", "kind": "needs", "parent_slug": "loans"},
    {"slug": "loan_consumer", "name": "Crédit conso", "color": "#3a38b8", "type": "expense", "icon": "💳", "kind": "needs", "parent_slug": "loans"},
